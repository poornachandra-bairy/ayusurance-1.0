...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const resetToSeed = useCallback(() => {
    storageReset({
      ...
      screeningV2Records: seedRecordsV2.screeningV2Records as AppState["screeningV2Records"],
      treatmentPlanV2Records: seedRecordsV2.treatmentPlanV2Records as AppState["treatmentPlanV2Records"],
      pkConsultationV2Records: seedRecordsV2.pkConsultationV2Records as AppState["pkConsultationV2Records"],
      reservationV2Records: seedRecordsV2.reservationV2Records as AppState["reservationV2Records"],
      portalOnboardingV2Records: seedRecordsV2.portalOnboardingV2Records as AppState["portalOnboardingV2Records"],
      travelPrepRecords: seedRecordsV2.travelPrepRecords as AppState["travelPrepRecords"],
      paymentRecords: seedRecordsV2.paymentRecords as AppState["paymentRecords"],
      arrivalAdmissionRecords: seedRecordsV2.arrivalAdmissionRecords as AppState["arrivalAdmissionRecords"],
      qualityChecklists: seedRecordsV2.qualityChecklists as AppState["qualityChecklists"],
    });
